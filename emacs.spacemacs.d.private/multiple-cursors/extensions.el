...
(setq multiple-cursors-pre-extensions
  '(
    ;; pre extension multiple-cursorss go here
    ))

(setq multiple-cursors-post-extensions
  '(
    ;; post extension multiple-cursorss go here
    ))

;; For each extension, define a function multiple-cursors/init-<extension-multiple-cursors>
;;
